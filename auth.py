...
async def tentar_login(context, usuario, senha, max_tentativas=3):
    """
    Tenta logar com as credenciais recebidas, repetindo o processo se
    falhar (pedindo novas credenciais no console a cada nova tentativa).
